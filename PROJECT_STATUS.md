...
- Deployed commit: `8e74d41`; healthy four-venue ingestion verified over approximately 20 hours
...
- Next gate: deploy five-minute Binance and Bybit silence bounds plus recovery-cause logging, then verify reconnect reduction through the remaining 48/72-hour measurements
