...
| Bybit | — | existing account; product access unknown | `USDCEUR`, `USDCUSDT` | unknown | EUR rails unknown | pending |
...
- [ ] Confirm trading access to `USDCEUR`.
- [ ] Record account-specific maker/taker fees.
